...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`B2C Car sharing v3`}</title>

        <meta
          name="description"
          content="Experience the ease of mobility with B2C Car Sharing v3. Book cars near you, managed by dedicated operations staff from centralized dashboards."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of mobility with B2C Car Sharing v3. Book cars near you, managed by dedicated operations staff from centralized dashboards.`}
            </Text>
            <Box
